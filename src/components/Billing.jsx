...
const Billing = () => (
  <section id="product" className={layout.sectionReverse}>
    <div className={layout.sectionImgReverse}>
      ...
      <div className="w-[60%] h-[60%] absolute z-[0] -left-[30%] rounded-full blue__gradient " />
    ...
    <div className={layout.sectionInfo}>
      ...
      <div className="flex flex-row flex-wrap sm:mt-10 mt-6">
        ...
        <img src={google} alt="google__play" className="w-[128.86px] h-[42.05px] object-contain cursor-pointer" />
      </div>
    </div>
  </section>
)
